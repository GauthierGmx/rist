...
Art = ["Peinture","Dessin","Photographie","Bande dessinée","Poésie","Théâtre","Cirque","Cinéma"]
Danse = ["Hip Hop","Breakdance","Jazz","Bachata","Disco","Pole Dance","Rock","Salsa","Slow","Zumba"]
Loisir = ["Pêche","Randonnée","Jeux de société","Jeu de piste","Escape Game","Accrobranche","Quizz","Lancer de hache","Laser game","Karaoké","Jeux Vidéo"]
